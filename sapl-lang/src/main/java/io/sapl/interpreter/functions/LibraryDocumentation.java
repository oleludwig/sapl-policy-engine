...
public class LibraryDocumentation {
    ...
    public boolean equals(final java.lang.Object o) {
        if (o == this)
            return true;
        if (!(o instanceof LibraryDocumentation))
            return false;
        final LibraryDocumentation other = (LibraryDocumentation) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof LibraryDocumentation;
    }
    ...
    public java.lang.String toString() {
        return "LibraryDocumentation(name=" + this.getName() + ", description=" + this.getDescription()
                + ", documentation=" + this.getDocumentation() + ")";
    }

    @java.lang.SuppressWarnings("all")
    // @lombok.Generated
    public LibraryDocumentation() {
    }

    @java.lang.SuppressWarnings("all")
    // @lombok.Generated
    public LibraryDocumentation(final String name, final String description) {
        java.util.Objects.requireNonNull(name, "name is marked non-null but is null");
        java.util.Objects.requireNonNull(description, "description is marked non-null but is null");
        this.name        = name;
        this.description = description;
