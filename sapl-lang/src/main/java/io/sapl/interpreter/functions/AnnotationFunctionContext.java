...
public class AnnotationFunctionContext implements FunctionContext {
    ...
    public static class FunctionMetadata implements LibraryEntryMetadata {
        ...
        @java.lang.SuppressWarnings("all")
        // @lombok.Generated
        public void setLibrary(final Object library) {
        ...
        public boolean equals(final java.lang.Object o) {
            if (o == this)
                return true;
            if (!(o instanceof AnnotationFunctionContext.FunctionMetadata))
                return false;
            final AnnotationFunctionContext.FunctionMetadata other = (AnnotationFunctionContext.FunctionMetadata) o;
            ...
            if (this$functionPathToSchema == null ? other$functionPathToSchema != null
                ...
                return false;
            final java.lang.Object this$library  = this.getLibrary();
            final java.lang.Object other$library = other.getLibrary();
        ...
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof AnnotationFunctionContext.FunctionMetadata;
        }
        ...
        public int hashCode() {
            ...
            final java.lang.Object $library = this.getLibrary();
            result = result * PRIME + ($library == null ? 43 : $library.hashCode());
        ...
        public java.lang.String toString() {
            return "AnnotationFunctionContext.FunctionMetadata(libraryName=" + this.getLibraryName() + ", functionName="
                    + this.getFunctionName() + ", functionSchema=" + this.getFunctionSchema()
                    + ", functionPathToSchema=" + this.getFunctionPathToSchema() + ", library=" + this.getLibrary()
                    + ", numberOfParameters=" + this.getNumberOfParameters() + ", function=" + this.getFunction() + ")";
        }

        @java.lang.SuppressWarnings("all")
        // @lombok.Generated
        public FunctionMetadata(final String libraryName, final String functionName, final String functionSchema,
                final String functionPathToSchema, final Object library, final int numberOfParameters,
