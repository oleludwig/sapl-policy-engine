...
public class CombinedDecision implements Traced {
    ...
    public java.lang.String toString() {
        return "CombinedDecision(authorizationDecision=" + this.getAuthorizationDecision() + ", combiningAlgorithm="
                + this.combiningAlgorithm + ", documentEvaluationResults=" + this.documentEvaluationResults
