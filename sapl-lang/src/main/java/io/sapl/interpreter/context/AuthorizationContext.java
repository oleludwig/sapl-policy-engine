...
public final class AuthorizationContext {
    ...
    public static Context setAttributeContext(Context ctx, AttributeContext attributeContext) {
        return ctx.put(ATTRIBUTE_CTX, attributeContext);
    }

    public static Context setVariables(Context ctx, Map<String, JsonNode> environmentVariables) {
    ...
    public static Context setVariable(Context ctx, String name, Val value) {
        java.util.Objects.requireNonNull(ctx, "ctx is marked non-null but is null");
        assertVariableNameNotReserved(name);
        if (value.isError())
    ...
    private static void assertVariableNameNotReserved(String name) {
    ...
    public static Context setSubscriptionVariables(Context ctx, AuthorizationSubscription authorizationSubscription) {
        java.util.Objects.requireNonNull(ctx, "ctx is marked non-null but is null");
    ...
    public static Context setFunctionContext(Context ctx, FunctionContext functionContext) {
        return ctx.put(FUNCTION_CTX, functionContext);
    }

    public static Context setImports(Context ctx, Map<String, String> imports) {
