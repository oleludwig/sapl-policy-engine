...
public class PolicyDecision implements DocumentEvaluationResult {
    ...
    @java.lang.SuppressWarnings("all")
    // @lombok.Generated
    public Decision getEntitlement() {
    ...
    @java.lang.SuppressWarnings("all")
    // @lombok.Generated
    public Optional<Val> getWhereResult() {
        return this.whereResult;
    }

    @java.lang.SuppressWarnings("all")
    // @lombok.Generated
    public Optional<Val> getResource() {
    ...
    public java.lang.String toString() {
        return "PolicyDecision(documentName=" + this.getDocumentName() + ", entitlement=" + this.getEntitlement()
                + ", targetResult=" + this.getTargetResult() + ", whereResult=" + this.getWhereResult()
                + ", obligations=" + this.getObligations() + ", advice=" + this.getAdvice() + ", resource="
                + this.getResource() + ", errorMessage=" + this.getErrorMessage() + ")";
    }
}
