...
public class CanonicalIndexDataCreationStrategy {
    ...
    private CanonicalIndexDataContainer constructContainerWithOrder(
        ...
        List<Predicate>                       predicateOrder                               = predicateOrderStrategy
                .createPredicateOrder(predicateInfos);
        Map<Integer, Set<DisjunctiveFormula>> indexToTargets                               = mapIndexToFormulas(
                clauseToIndex, clauseToFormulas);
        Map<DisjunctiveFormula, Bitmask>      relatedCandidates                            = mapFormulaToClauses(
                formulaToDocuments.keySet(), clauseToIndex);
        int[]                                 numberOfLiteralsInConjunction                = mapIndexToNumberOfLiteralsInConjunction(
                clauseToIndex.inverse());
        int[]                                 numberOfFormulasWithConjunction              = mapIndexToNumberOfFormulasWithConjunction(
                clauseToIndex.inverse(), clauseToFormulas);
        ...
        List<Set<DisjunctiveFormula>>         relatedFormulas                              = flattenIndexMap(
                indexToTargets);
    ...
    // @lombok.Generated
    public CanonicalIndexDataCreationStrategy(final PredicateOrderStrategy predicateOrderStrategy) {
