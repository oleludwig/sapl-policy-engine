...
public final class EquivalenceAndHashUtil {
    ...
    public static int semanticHash(EObject thiz, Map<String, String> imports) {
        java.util.Objects.requireNonNull(thiz, "thiz is marked non-null but is null");
        java.util.Objects.requireNonNull(imports, "imports is marked non-null but is null");
    ...
    private static int hashFStepRespectingImports(Object featureInstance, Map<String, String> imports) {
        java.util.Objects.requireNonNull(imports, "imports is marked non-null but is null");
        return resolveStepsToFullyQualifiedName((EList<Object>) featureInstance, imports).hashCode();
    }

    private static int hash(Object featureInstance, Map<String, String> imports) {
        java.util.Objects.requireNonNull(imports, "imports is marked non-null but is null");
    ...
    public static boolean areEquivalent(EObject thiz, Map<String, String> thizImports, EObject that,
            Map<String, String> thatImports) {
        java.util.Objects.requireNonNull(thiz, "thiz is marked non-null but is null");
        java.util.Objects.requireNonNull(thizImports, "thizImports is marked non-null but is null");
        java.util.Objects.requireNonNull(that, "that is marked non-null but is null");
        java.util.Objects.requireNonNull(thatImports, "thatImports is marked non-null but is null");
        if (thiz == that) {
            return true;
        }
    ...
    @SuppressWarnings("unchecked")
    private static boolean fStepsAreEquivalentWithRegardsToImports(Object thisFeatureInstance,
            Map<String, String> thisImports, Object thatFeatureInstance, Map<String, String> thatImports) {
        java.util.Objects.requireNonNull(thisImports, "thisImports is marked non-null but is null");
        java.util.Objects.requireNonNull(thatImports, "thatImports is marked non-null but is null");
    ...
    private static String resolveStepsToFullyQualifiedName(EList<Object> steps, Map<String, String> imports) {
        java.util.Objects.requireNonNull(imports, "imports is marked non-null but is null");
